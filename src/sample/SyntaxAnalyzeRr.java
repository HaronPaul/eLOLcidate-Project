...
public class SyntaxAnalyzer {
    ...
    void checkSyntax(ArrayList<Token> stringLine, int lineNumber) {
        ...
        if ((stringLine.get(0).getLexeme().equals("HAI")) || (stringLine.get(1).getLexeme().equals("KTHXBYE"))) {
            if(stringLine.get(0).getLexeme().equals("I HAS A")) {
    ...
    //checks if program is goods i run, nag start sa HAI at nag end sa KTHXBYE
//    void programChecker (ArrayList<Token> stringLine, int lineNumber) {
//
//        try {
//            Reader reader = new FileReader(stringLine.get(0).getLexeme());
//
...
//
//
//                if ((stringLine.get(1).getLexeme().equals("HAI")) && (line.equals("KTHXBYE"))) {
//                    b = true;
//
//                } else {
//                    b = false;
...
//    boolean isProgram (ArrayList<Token> stringLine) {
//        if ((stringLine.get(0).getLexeme().equals("HAI")) && (stringLine.get(0).getLexeme().equals("KTHXBYE"))) {
//            return true;
//        } else {
//            return false;
//        }
